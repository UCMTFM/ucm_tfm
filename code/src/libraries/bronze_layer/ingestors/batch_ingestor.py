...
class BatchIngestor(BaseIngestor):
    ...
    def ingest(self) -> None:
        ...
        lkh_account = self.config.get("lakehouse_storage_account_name")
        lkh_container_name = self.config.get("lakehouse_container_name")
        lakehouse_container = f"abfss://{lkh_container_name}@{lkh_account}.dfs.core.windows.net"

        ldg_account = self.config.get("landing_storage_account_name")
        ldg_container_name = self.config.get("landing_container_name")
        landing_container = f"abfss://{ldg_container_name}@{ldg_account}.dfs.core.windows.net"
