...
class TestDatabricksGenieClientConversationManagement:
    def test_get_or_create_conversation_starts_new_conversation_when_none_exists(self):
        ...
        genie_api_mock = Mock()
        genie_api_mock.start_conversation_and_wait.return_value = conversation_response_mock
    ...
    def test_get_or_create_conversation_returns_cached_conversation_when_already_set(self):
        # Given
        config = DatabricksConfig(
            workspace_url="https://test.databricks.com",
            access_token="test_token"
    ...
    def test_get_or_create_conversation_handles_api_error_gracefully(self):
        ...
        genie_api_mock = Mock()
        genie_api_mock.start_conversation_and_wait.side_effect = Exception("Conversation creation failed")
...
class TestDatabricksGenieClientQueryExecution:
    ...
    def test_query_genie_processes_message_with_text_attachments(self):
        ...
        text_attachment_mock.text.content = "This query shows sales data from the last quarter"
        ...
        assert result["explanation"] == "This query shows sales data from the last quarter"
    ...
    def test_query_genie_processes_message_with_query_attachments(self):
        ...
        query_attachment_mock.query.query = "SELECT * FROM sales WHERE date > '2024-01-01'"
        ...
        query_result_mock.statement_response.result.data_array = [["Product A", 1000], ["Product B", 2000]]
        ...
        query_result_mock.statement_response.result.manifest.schema.columns = [column_mock_1, column_mock_2]
    ...
    def test_query_genie_handles_query_execution_error_gracefully(self):
        ...
        genie_api_mock = Mock()
        genie_api_mock.create_message_and_wait.return_value = message_response_mock
        genie_api_mock.execute_message_attachment_query.side_effect = Exception("Table does not exist")
        ...
        assert result["result"]["summary"] == "Error executing query: Table does not exist"
    ...
    def test_query_genie_handles_api_error_gracefully(self):
        ...
        genie_api_mock = Mock()
        genie_api_mock.create_message_and_wait.side_effect = Exception("API request failed")
...
class TestDatabricksGenieClientTableOperations:
    ...
    def test_get_available_tables_uses_provided_catalog_and_schema_when_specified(self):
        ...
        # When
        result = client.get_available_tables(catalog="special_catalog", schema="special_schema")
